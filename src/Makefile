...
PROGNAME = donkey-kong

# Here you must put a list of all of the object files
# that will be compiled into your program. For example
# if you have main.c and myLib.c then in the following
# line you would put main.o and myLib.o
OFILES = project.o font.o splash_screen.o win_screen.o game_over.o barrel_one.o barrel_two.o barrel_three.o barrel_four.o mario_left.o mario_right.o mario_buttcheek.o kong_array.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = myLib.h splash_screen.h win_screen.h game_over.h barrel_one.h barrel_two.h barrel_three.h barrel_four.h mario_left.h mario_right.h mario_buttcheek.h kong_array.h
